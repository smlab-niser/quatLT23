...
class CNNBlock(nn.Module):
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        # print(in_channels, out_channels, self.conv.weight.shape, sep="\t")
...
class Pretraining(nn.Module):
    def __init__(self, in_channels=3, S=7, name="pretraining_real"):
        super().__init__()
...
class Yolov1(nn.Module):
    def __init__(self, base_path, in_channels=4, S=7, B=2, C=20, name="yolov1_real", device=torch.device("cpu")):
